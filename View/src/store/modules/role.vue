<template>
  <div class="app-container">
    ...
    <el-table :data="rolesList" style="width: 100%;margin-top:30px;" border>
      ...
      <el-table-column align="header-center" label="displayName">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    async getRoutes() {
      ...
      this.routes = this.generateRoutes(this.$store.state.permission.routes)
    },
    async getRoles() {
    ...
    generateRoutes(routes, basePath = '/') {
      ...
      for (let route of routes) {
        ...
        const onlyOneShowingChild = this.onlyOneShowingChild(route)
