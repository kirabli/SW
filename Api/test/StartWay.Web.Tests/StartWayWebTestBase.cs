...
{
    public abstract class StartWayWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static StartWayWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(StartWayWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<StartWayDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<StartWayDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<StartWayDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<StartWayDbContext, Task<T>> func)
        {
            T result;
