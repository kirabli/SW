...
namespace StartWay.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly StartWayDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = StartWayConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(StartWayDbContext context)
        {
            _context = context;
        }
